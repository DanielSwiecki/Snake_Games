package com.example.snakegame.data.cache
...
import com.example.snakegame.domain.base.DATASTORE_KEY_HIGH_SCORES
import com.example.snakegame.domain.base.DATASTORE_KEY_PLAYER_NAME
import com.example.snakegame.domain.base.DATASTORE_NAME
...
class GameCache(private val context: Context) {
    ...
    val getPlayerName: Flow<String> = context.dataStore.data.map { preferences ->
        preferences[PLAYER_NAME_KEY] ?: context.getString(com.example.snakegame.R.string.player_name)
    }
